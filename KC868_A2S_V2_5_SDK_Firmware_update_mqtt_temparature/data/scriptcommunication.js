function verifyform() {
alert("Device will be Restart...");


  if (
    document.getElementById("mqtt_communication_status").textContent == "ON"
  ) {
  ...
  if (
    document.getElementById("socket_communication_status").textContent == "ON"
  ) {
    if (
  ...
  if (
    document.getElementById("http_communication_status").textContent == "ON"
  ) {
...
function loadConfigFileData() {
  ...
  try {
    ...
    // document.getElementById("mqtt_communication_status").textContent ==
    // jsonData.mqtt_communication
    //   ? "ON"
    //   : "OFF";
    // document.getElementById("http_communication_status").textContent ==
    // jsonData.mqtt_communication
    //   ? "ON"
    //   : "OFF";
    // document.getElementById("socket_communication_status").textContent ==
    // jsonData.mqtt_communication
    //   ? "ON"
    //   : "OFF";
    document.getElementById("socket_communication").checked =
      jsonData.socket_communication;
    document.getElementById("mqtt_communication").checked =
      jsonData.mqtt_communication;
    document.getElementById("http_communication").checked =
      jsonData.http_communication;

    document.getElementById("mqtt_settings").style.display =
      jsonData.mqtt_communication ? "block" : "none";
    document.getElementById("socket_settings").style.display =
      jsonData.socket_communication ? "block" : "none";
    document.getElementById("http_settings").style.display =
      jsonData.http_communication ? "block" : "none";
